            ...
            <div class="d-flex justify-content-center">
                ...
                <form class="w-75 form-add-comic" action="{{ route('comics.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-center pt-3">
                        <button type="submit" class="btn my-btn-comics btn-add-comic text-uppercase pe-5 ps-5 me-2">Add</button>
                        <a href="{{ route('comics.index') }}" class="btn my-btn-comics btn-add-comic text-uppercase pe-5 ps-5 ms-2">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
